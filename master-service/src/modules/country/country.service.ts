...
import type { createCountryDto, updateCountryDto } from '../../master-service/dto'; // Ungaloda dto.ts file path
import { CountryResponse, CountriesPaginatedResponse } from '../../master-service/response';
