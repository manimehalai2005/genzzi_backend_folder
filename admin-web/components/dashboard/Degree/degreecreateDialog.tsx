...
import { useCreateDegree } from '@/hooks/useDegreehook';
...
export function DegreeCreateDialog() {
  ...
  const { mutateAsync: createDegree, isPending: isCreating } =
    useCreateDegree();
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const errorMessage = err?.message || 'Failed to create degree';
