...
export function CityTable({ cities }: CityTableProps) {
  // Safely normalize the cities prop to guarantee it's always an array
  const safeCities = Array.isArray(cities)
    ? cities
    : Array.isArray((cities as any)?.data)
      ? (cities as any).data
      : Array.isArray((cities as any)?.cities)
        ? (cities as any).cities
        : [];
  ...
  if (!safeCities || safeCities.length === 0) {
    return (
      <div
        className="
          flex
      ...
      >
        ...
        <p
          ...
          "
        >
          Add your first record to start vibe-checking your regions.
        </p>
      </div>
    );
  }
        ...
        >
          ...
          >
            ...
            <div>
              ...
              >
                Delete{' '}
                <span className="text-rose-500">{cityToDelete?.name}</span>?
              </DialogTitle>
              ...
              <p
                ...
                "
              >
                This action is irreversible. It will wipe this city record
                completely from the database. Proceed with caution.
              </p>
            </div>
          </DialogHeader>
