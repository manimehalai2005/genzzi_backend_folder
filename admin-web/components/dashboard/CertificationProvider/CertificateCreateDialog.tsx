...
export function CertificationProviderCreateDialog() {
  ...
  return (
    <Dialog open={open} onOpenChange={setOpen}>
      ...
      {/* Mobile-optimized classes: max-h, overflow-y-auto, and responsive width */}
      <DialogContent className="w-[92%] sm:max-w-[425px] max-h-[85vh] overflow-y-auto rounded-2xl bg-card border-border/50 backdrop-blur-xl p-6 modal-scrollbar">
        ...
        <form onSubmit={handleSubmit} className="space-y-4 py-2">
          ...
          <div className="space-y-2">
            <Label
              className="text-foreground/90 text-xs sm:text-sm font-medium"
              htmlFor="create-code"
            >
              Code
            </Label>
            <Input
              ...
              className="bg-background/50 border-border text-sm sm:text-base focus-visible:ring-brand-orange uppercase h-11 sm:h-10"
            />
          </div>
