...
export function CertificationProviderTable({
  ...
  if (safeProviders.length === 0) {
    return (
      <div className="  flex  min-h-[180px]   flex-col   items-center  justify-center  rounded-3xl  border  border-dashed  border-fuchsia-500/3  bg-card/40 px-4 py-12 text-center shadow-xl backdrop-blur-xl sm:min-h-[220px]  ">
        ...
        >
          <DialogHeader className="space-y-3">
            ...
            <div>
              ...
              >
                Delete{' '}
                <span className="text-rose-500">{providerToDelete?.name}</span>?
              </DialogTitle>
              ...
              <p
                ...
                "
              >
                This action is permanent. This provider will be removed from the
                database.
              </p>
            </div>
          </DialogHeader>
