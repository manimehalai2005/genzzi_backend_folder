...
export function CollegeDepartmentCreateDialog() {
  ...
  const { mutateAsync: createCollegeDepartment, isPending: isCreating } =
    useCreateCollegeDepartment();

  const handleSubmit = async (e: React.FormEvent) => {
    e.preventDefault();

    console.log(
      'Submitting Payload -> College ID:',
      collegeId,
      'Department ID:',
      departmentId,
    );
    ...
    try {
      ...
      const errorMessage =
        ...
        err?.message ||
        'Failed to create college department';
