...
import { useCreateCurrency } from '@/hooks/useCurrencyhook';
...
export function CurrencyCreateDialog() {
  ...
  const { mutateAsync: createCurrency, isPending: isCreating } = useCreateCurrency();
  ...
  return (
    <Dialog open={open} onOpenChange={setOpen}>
      ...
      >
        <Plus className="w-4 h-4 stroke-[3]" /> Add Currency
      </DialogTrigger>
      ...
      >
        ...
        <DialogHeader className="space-y-1.5 text-center sm:text-left">
          ...
          <p className="text-xs text-muted-foreground font-medium">
            Setup a new currency denomination for global exchange tracking.
          </p>
        </DialogHeader>
        ...
        <form onSubmit={handleSubmit} className="space-y-4 pt-1">
          <div className="space-y-1.5">
            ...
            >
              Currency Code <span className="text-fuchsia-500">*</span>
            </Label>
            <Input
              id="code"
              value={code}
