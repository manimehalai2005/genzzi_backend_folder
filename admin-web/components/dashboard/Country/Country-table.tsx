...
import { useCountries, useDeleteCountry } from '@/hooks/useCountryhook';
...
export function CountryTable() {
  ...
  const { data: countryResponse, isLoading } =
    useCountries(page, limit);
        ...
        <div className="overflow-x-auto">
          <table className="w-full text-left text-sm">
            ...
            <thead className="bg-muted/50 border-b border-border/40 text-muted-foreground font-black text-xs uppercase tracking-wider">
              <tr>
                <th className="p-4 sm:p-5 text-xl">
                  Flag
                </th>
                ...
                <th className="p-4 sm:p-5 text-right text-xl">
                  Actions
                </th>
              </tr>
            </thead>
