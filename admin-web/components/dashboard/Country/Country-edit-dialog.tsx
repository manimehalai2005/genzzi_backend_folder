            ...
            <div className="space-y-1.5">
              ...
              >
                ...
                >
                  <SelectItem
                    value="Published"
                    className="w-full cursor-pointer rounded-xl py-2.5 px-3 font-medium text-emerald-500"
                  >
                    🟢 Published
                  </SelectItem>
                  <SelectItem
                    value="Draft"
                    className="w-full cursor-pointer rounded-xl py-2.5 px-3 font-medium text-amber-500"
                  >
                    🟡 Draft
                  </SelectItem>
                </SelectContent>
