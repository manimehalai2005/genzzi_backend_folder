import {Country,State,City,Language,Currency,Timezone,Skill,Industry,Degree,University,CertificationProvider,FileType,SocialPlatform,College,Department,CollegeDepartment} from "../micro-services/types.js";
