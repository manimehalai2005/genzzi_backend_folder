...
import  type { createCollegeDepartmentDto, updateCollegeDepartmentDto } from '../dto.js';
import { CollegeDepartmentResponse, CollegeDepartmentsPaginatedResponse } from '../response.js';
